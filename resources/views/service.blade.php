...
and skin care services will suit every beauty need.</p>
			...
			<div class="agileinfo-top-grids">
				<div class="col-sm-4 wthree-top-grid">
					<img src="{{ asset('homepage/images/p11.jpg') }}" class="img-responsive" alt="" />
				...
				<div class="col-sm-4 wthree-top-grid">
					<img src="{{ asset('homepage/images/p4.jpg') }}" class="img-responsive" alt="" />
					<h4>Hair Coloring</h4>
					<p>Pellentesque auctor euismod lectus a pretium. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
				</div>
				<div class="col-sm-4 wthree-top-grid">
					<img src="{{ asset('homepage/images/p5.jpg') }}" class="img-responsive" alt="" />
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4>Beauty Salon</h4>
					<img src="{{ asset('homepage/images/11.jpg') }}" alt=" " class="img-responsive">
