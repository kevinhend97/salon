...
<head>
	...
	<link rel="stylesheet" href="{{ asset('homepage/css/owl.carousel.css') }}" type="text/css" media="all" />
	<link rel="stylesheet" href="{{ asset('homepage/css/flexslider.css') }}" type="text/css" media="screen" property="" />
	<!--// Owl-Carousel-CSS -->
...
<body>
			...
			<div class="container">
				<div class="header-bottom-agileits">
					...
					<div class="address">
						...
						<p class="para-y"><a href="{{ url('/contact') }}">Dapatkan Info Lengkapnya</a></p>
					</div>
			...
			<nav class="navbar navbar-default shift">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="{{ route('page.reservation') }}">Reservasi</a></li>
						<li><a href="{{ route('page.galeri') }}">Galeri</a></li>
	...
	<!-- //smooth scrolling -->
	<script type='text/javascript' src="{{ asset('homepage/js/jquery-2.2.3.min.js') }}"></script>
